...
<head>
 ...
 <script>/* This HTML was generated by 📜 Scroll v143.0.0. https://scroll.pub */</script>
 <style>@media print {.doNotPrint {display: none !important;}}</style>
 <link rel="canonical" href="https://scroll.pub/readme.html">
 <meta name="viewport" content="width=device-width,initial-scale=1">
 <meta name="description" content="Scroll is a language for scientists of all ages">
 <meta name="generator" content="Scroll v143.0.0">
...
<style>html {font-family: "SF Pro", "Helvetica Neue", "Segoe UI", "Arial"; font-size: var(--base-font-size, 14px);}</style>
...
<style>html {font-size: var(--base-font-size, 18px); font-weight: 400;}</style>
<div class="scrollSection"><h1 id="particle18" style="font-weight: 300; font-size: 200%;" class="scrollTitle">Scroll is a language for scientists of all ages</h1>
</div>
<div class="scrollSection"><h2 id="particle20" style="font-weight: 300;" class="scrollParagraph">Publish and evolve your most intelligent ideas</h2>
</div>
<br>
<div class="scrollColumns" style="column-width:65ch;column-count:1;max-width:65ch;">
<br>
<div  id="theAnimation"  class="">
<p id="particle28" class="scrollParagraph">With Scroll your</p>
<p id="particle29" class="animationLine"><span class="atomToDot">Lines</span> <span class="atomToDot">become</span> <span class="atomToDot">particles</span></p>
<p id="particle30" class="animationLine"><span class="atomToDot2">United</span> <span class="atomToDot2">with</span> <span class="atomToDot2">parsers</span></p>
<p id="particle31" class="scrollParagraph">To lead the world</p>
</div>
<link rel="stylesheet" type="text/css" href="animation.css">
<br><br>
<p id="particle38" class="scrollParagraph"><center><a href="http://hub.scroll.pub/"><span class="scrollButton">ScrollHub</a></span> &nbsp;&nbsp; <a href="https://try.scroll.pub/"><span class="scrollButton">Try now</center></a></span></p>
<p id="particle40" style="margin:15px; margin-top: 40px;" class="scrollParagraph"><center><a href="leetsheet.html">LeetSheet</a> · <a href="blog/index.html">Blog</a> · <a href="faq.html">FAQ</a> · <a href="tutorial.html">Tutorial</center></a></p>
<p id="particle42" style="margin:15px;" class="scrollParagraph"><center><a href="https://www.youtube.com/@breckyunits">Videos</a> · <a href="releaseNotes.html">Release Notes</a> · <a href="https://www.reddit.com/r/WorldWideScroll/">Subreddit</center></a></p>
<p id="particle44" style="margin:15px;" class="scrollParagraph"><center><a href="https://www.npmjs.com/package/scroll-cli">npm package</a> · <a href="tests/index.html">Tests</a> · <a href="https://sdk.scroll.pub/designer#url%20https%3A%2F%2Ftry.scroll.pub%2Fscroll.parsers">Parser Designer</center></a></p>
<p id="particle46" style="margin:15px;" class="scrollParagraph"><center><a href="scrollPrompt.txt">scroll prompt</a> · <a href="parserPrompt.txt">parser prompt</center></a></p>
</div>
<div class="scrollKeyboardNav" style="display:none;"><a href="undefined">undefined</a> · readme.html · <a href="undefined">undefined</a><script>document.addEventListener('keydown', function(event) {
...
<center><p id="particle56" class="scrollParagraph"></p>
...
<div class="abstractTextLinkParser"><a href="https://scroll.pub">Built with Scroll v143.0.0</a></div>
</center>
</body>
</html>